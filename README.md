...
data, ready for generative modeling. The transforms are reversible, allowing you to convert from numerical
data back into your original format, thus fully generating data in the original format. 
