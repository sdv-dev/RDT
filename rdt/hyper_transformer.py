...
class HyperTransformer:
    ...
    def _validate_output_columns(self, output_columns):
        repeated_columns = set(output_columns) & set(self._output_columns)
        if repeated_columns:
            raise ValueError(
                'The column names generated by the transformers must be unique. The following'
                f'output columns were produced multiple times: {repeated_columns}.'
            )
